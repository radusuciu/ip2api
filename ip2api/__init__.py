...
MD5_CHECK_INTERVAL=10
MD5_CHECK_TIMEOUT=1200
CONVERT_CHECK_INTERVAL=60
CONVERT_CHECK_TIMEOUT=14400
...
class IP2Experiment:
    ...
    def get_dtaselect_link(self):
        ...
        link_el = search_td.find_next_sibling('td').find('a', text='Result View')
